...
const STRINGS: { [s: string]: string|string[] } = {
    ...
    get C_ADDREGEX_E_UNSAFE() { return "The RegExp `{{}}` is not supported by Snitch. It got flagged as a malicious RegExp, " + this.FALSE_POSITIVE },
    get C_ADDREGEX_E_MATCHES() { return "The RegExp `{{}}` matches to much cases and got flagged as malicious, " + this.FALSE_POSITIVE },
    C_WAIT_SUCCESS: "You are now waiting in **{{}}**",
    C_WAIT_E_DUPLICATE: "You are already waiting in **{{}}**",
    C_UNWAIT_SUCCESS: "You stopped waiting in **{{}}**",
    C_UNWAIT_E_NOT_LISTED: "You were not waiting in **{{}}**",
